...
const Hero = () => {
  ...
  useEffect(() => {
    fetch('https://lottie.host/4db68bde-31f6-4cd0-825f-872ba3e4ac47/yXMTlyyLhK.json')
      .then(response => response.json())
      .then(data => setAnimationData(data))
      .catch(error => console.log('Animation load error:', error));
  }, []);
  ...
  return (
    <section className={styles.hero}>
      <div className={styles.vantaContainer}></div>
      {animationData && (
      ...
      <div className="container">
        <div className={styles.heroContent}>
          <div className={styles.heroText}>
            ...
            <h1 className={styles.name}>MIRUTHULAA M</h1>
